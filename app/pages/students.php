...
<button class="button" data-open="exampleModal1">Agregar estudiante</button>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', e => {
    ...
    const $profesoresLink = $links.find(link => link.textContent.trim() === 'Estudiantes');
